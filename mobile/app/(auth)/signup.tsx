  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: t.bg }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "center", padding: spacing.xl }}>
        <Text style={{ fontSize: 28, fontWeight: "800", color: t.text, marginBottom: spacing.xs }}>Create account</Text>
        <Text style={{ color: t.textMuted, marginBottom: spacing.xl }}>Takes a minute.</Text>
        ...
        <Field label="Name" value={name} onChangeText={setName} placeholder="Rohith" />
        ...
        <View style={{ flexDirection: "row", justifyContent: "center", marginTop: spacing.lg }}>
          ...
          <Link href="/(auth)/login"><Text style={{ color: t.accent, fontWeight: "700" }}>Log in</Text></Link>
        </View>
      </ScrollView>
